...
const SvgFunctionPython = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#function-python_svg__clip0_1534_28977)">
      <path
        stroke="#fff"
        strokeWidth={1.5}
